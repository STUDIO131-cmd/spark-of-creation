  ...
  return (
    <section id="conteudo" className="py-12 px-4 bg-black">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <a
          href="#orcamento"
          className="inline-flex items-center gap-2 mt-8 px-6 py-3 rounded-lg font-tiktok font-medium text-lg text-white transition-all hover:-translate-y-0.5 bg-gold">
