  ...
  return (
    <section className="py-8 bg-black">
      <div className="relative max-w-4xl mx-auto px-12">
        <button
          onClick={goToPrev}
          className="absolute left-0 top-1/2 -translate-y-1/2 z-10 text-white hover:opacity-70"
        >
          <ChevronLeft size={48} />
        </button>
        ...
        <button
          onClick={goToNext}
          className="absolute right-0 top-1/2 -translate-y-1/2 z-10 text-white hover:opacity-70"
        >
