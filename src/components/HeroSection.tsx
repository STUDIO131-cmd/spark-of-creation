const HeroSection = () => {
  return (
    <section
      ...
      {/* Main description */}
      <p className="font-tiktok text-white/90 text-center text-base md:text-lg leading-relaxed mt-6 max-w-xl tracking-wide">Nós operamos a estratégia de comunicação enquanto o dono segue focado na operação do negócio.
        <br />
